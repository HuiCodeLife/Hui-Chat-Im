<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="发送者id" prop="sendUserId">
        <el-input
      ...
      <el-form-item label="接收者id" prop="acceptUserId">
        <el-input
...
<!--      </el-col>-->
    ...
    <el-table v-loading="loading" :data="msgList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="发送者id" align="center" prop="sendUserId" />
      <el-table-column label="接收者id" align="center" prop="acceptUserId" />
...
<!--          >修改</el-button>-->
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="发送者id" prop="sendUserId">
          <el-input v-model="form.sendUserId" placeholder="请输入发送者id" />
        </el-form-item>
        <el-form-item label="接收者id" prop="acceptUserId">
          <el-input v-model="form.acceptUserId" placeholder="请输入接收者id" />
        </el-form-item>
